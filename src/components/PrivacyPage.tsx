...
const PrivacyPage: React.FC<PrivacyPageProps> = ({ darkMode }) => {
  return (
    <>
      <SEO 
        title="Privacy Policy | CancerRisk - Data Protection & Security"
        description="Learn how CancerRisk protects your personal health information. Our comprehensive privacy policy covers data collection, usage, security measures, and your rights."
        keywords="privacy policy, data protection, health information security, HIPAA compliance, personal data, user rights, data privacy"
        url="/privacy"
      />

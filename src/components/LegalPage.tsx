...
const LegalPage: React.FC<LegalPageProps> = ({ darkMode }) => {
  return (
    <>
      <SEO 
        title="Legal Information | CancerRisk - Terms of Service & Disclaimers"
        description="Important legal information about using our cancer risk assessment platform. Read our terms of service, medical disclaimers, and liability information."
        keywords="legal information, terms of service, medical disclaimer, liability, intellectual property, governing law, dispute resolution"
        url="/legal"
      />
